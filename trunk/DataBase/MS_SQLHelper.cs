...
namespace DataBase
{
    ...
    public sealed class SqlHelper
    {
        ...
        public static object GetColumnsValue(DataRow dr, string columnsName, object value)
        {
            DataTable dt = dr.Table;
            if (dt.Columns.IndexOf(columnsName) != -1 && dr[columnsName] != DBNull.Value)
            {
                value = dr[columnsName];
            }
            return value;
        }

        public static bool CheckColumnsValue(DataRow dr, string columnsName)
        {
            bool check = false;
            DataTable dt = dr.Table;
            if (dt.Columns.IndexOf(columnsName) != -1 && dr[columnsName] != DBNull.Value)
        ...
        public static SqlParameter MakeParam(string ParamName, SqlDbType DbType, Int32 Size, ParameterDirection Direction, object Value)
        {
            ...
            if (Value == null || (Value is DateTime && Convert.ToDateTime(Value) == DateTime.MinValue)) Value = DBNull.Value;
